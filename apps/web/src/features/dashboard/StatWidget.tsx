...
export const StatWidget: React.FC<StatItemProps> = ({
  title,
  value,
  change,
  isPositive = true,
  ...
  return (
    <div className="bg-[#172033] border border-white/10 hover:border-white/20 rounded-xl p-5 shadow-lg transition-all duration-200 flex items-center justify-between">
