...
exports.SystemStatusWidget = void 0;
...
const SystemStatusWidget = () => {
    ...
    return (<div className="bg-[#172033] border border-white/10 rounded-xl p-5 shadow-lg space-y-3">
      ...
      <div className="grid grid-cols-2 gap-2 text-xs">
        {services.map((s) => (<div key={s.name} className="p-2.5 bg-slate-900/60 border border-white/5 rounded-lg flex items-center justify-between">
...
exports.SystemStatusWidget = SystemStatusWidget;
