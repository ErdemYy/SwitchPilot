    ...
    return (<div className="min-h-screen bg-[#f0f0f0] text-slate-800 font-sans">
      ...
      <div className="py-16 px-6 max-w-[1536px] mx-auto space-y-10">
        <div className="text-center max-w-3xl mx-auto space-y-3">
          <ui_1.Badge variant="primary" size="sm">DEEP-DIVE MODULE SHOWCASE</ui_1.Badge>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {modules.map((m) => (<div key={m.title} className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200 space-y-3">
