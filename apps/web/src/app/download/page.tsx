    ...
    <div className="min-h-screen bg-[#f0f0f0] text-slate-800 font-sans">
      ...
      <div className="py-16 px-6 max-w-[1536px] mx-auto space-y-10">
        <div className="text-center max-w-3xl mx-auto space-y-3">
          <Badge variant="primary" size="sm">OFFICIAL DOWNLOAD CENTER</Badge>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {downloads.map((d) => (
            <div key={d.os} className="bg-white rounded-2xl p-6 shadow-sm border border-slate-200 space-y-4">
              ...
              <div className="space-y-3 pt-2">
                {d.builds.map((b) => (
                  <div key={b.arch} className="p-3 bg-slate-50 rounded-xl border border-slate-200 space-y-1.5">
                    ...
                    <Button variant="primary" size="sm" onClick={() => alert(`Downloading ${b.arch}...`)}>
                      ⬇ Download Binary
                    </Button>
                  </div>
                ))}
