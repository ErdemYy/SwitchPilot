    ...
    return (<div className="min-h-screen bg-[#f0f0f0] text-slate-800 font-sans">
      ...
      <div className="py-16 px-6 max-w-[1536px] mx-auto space-y-12">
        <div className="text-center max-w-3xl mx-auto space-y-3">
          <ui_1.Badge variant="primary" size="sm">TRANSPARENT PRICING</ui_1.Badge>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {tiers.map((t) => (<div key={t.name} className="bg-white rounded-2xl p-5 shadow-sm border border-slate-200 flex flex-col justify-between space-y-4">
              <div className="space-y-3">
                ...
                <div className="border-t border-slate-100 pt-3 space-y-2">
                  {t.features.map((f, i) => (<div key={i} className="flex items-start space-x-1.5 text-[11px] text-slate-700">
              ...
              <link_1.default href="/contact">
                <ui_1.Button variant={t.name === 'Enterprise' ? 'primary' : 'secondary'} size="sm" className="w-full">
