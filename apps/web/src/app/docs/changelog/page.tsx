...
export default function ChangelogPage() {
  ...
  return (
    <AppShell
      ...
      pageTitle="Product Version History & Release Notes"
      pageSubtitle="Changelog, release highlights, breaking changes, and migration guides."
      breadcrumbItems={[{ label: 'Documentation', href: '/docs' }, { label: 'Changelog' }]}
    >
      <div className="space-y-4 text-xs">
        {releases.map((rel) => (
          <Card key={rel.version} title={rel.version}>
