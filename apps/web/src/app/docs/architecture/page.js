...
exports.default = ArchitectureViewerPage;
const react_1 = __importDefault(require("react"));
const AppShell_1 = require("../../../layouts/AppShell");
const ui_1 = require("@switchpilot/ui");
function ArchitectureViewerPage() {
    return (<AppShell_1.AppShell currentPath="/docs/architecture" pageTitle="Interactive System Architecture Viewer" pageSubtitle="Visual overview of SwitchPilot Clean Architecture, EventBus domain events, Execution Pipeline, and Desktop Runtimes." breadcrumbItems={[{ label: 'Documentation', href: '/docs' }, { label: 'Architecture Viewer' }]}>
      <div className="space-y-4 text-xs">
        <ui_1.Card title="SwitchPilot Platform Clean Architecture Map">
