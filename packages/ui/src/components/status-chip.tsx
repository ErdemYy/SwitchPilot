...
export type StatusType = 'online' | 'offline' | 'warning' | 'syncing' | 'error';
...
export const StatusChip: React.FC<StatusChipProps> = ({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[11px] font-medium border ${cfg.bg} ${cfg.text} ${className}`}
    >
